...
exports.sessionNotifier = exports.SessionNotifier = void 0;
 ...
 */
class SessionNotifier extends events_1.EventEmitter {
    constructor() {
        super();
        this.listenClient = null;
        this.connected = false;
        this.printedSessions = new Set(); // Track which sessions have been auto-printed
    }
    /**
    ...
    async start() {
        ...
        try {
            ...
            this.listenClient = new pg_1.Client(clientConfig);
     ...
     */
    hasBeenPrinted(sessionId) {
        return this.printedSessions.has(sessionId);
    }
}
exports.SessionNotifier = SessionNotifier;
// Export singleton instance
exports.sessionNotifier = new SessionNotifier();
//# sourceMappingURL=sessionNotifier.js.map