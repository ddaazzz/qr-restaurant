...
router.get('/restaurants/:restaurantId/addon-presets/:presetId', async (req: Request, res: Response) => {
  try {
    ...
    const result = await pool.query(
      `SELECT * FROM addon_presets WHERE id = $1 AND restaurant_id = $2`,
...
router.get('/restaurants/:restaurantId/addon-presets/:presetId/items', async (req: Request, res: Response) => {
  try {
    ...
    const result = await pool.query(
      `SELECT api.id, api.addon_preset_id, api.menu_item_id, 
...
router.post('/restaurants/:restaurantId/addon-presets', async (req: Request, res: Response) => {
  try {
    ...
    const result = await pool.query(
      `INSERT INTO addon_presets (restaurant_id, name, description, is_active)
       VALUES ($1, $2, $3, $4)
       RETURNING *`,
      [restaurantId, name, description || null, is_active]
    );
...
router.post('/restaurants/:restaurantId/addon-presets/:presetId/items', async (req: Request, res: Response) => {
  try {
    ...
    const presetCheck = await pool.query(
      `SELECT id FROM addon_presets WHERE id = $1 AND restaurant_id = $2`,
      [presetId, restaurantId]
    );
    ...
    const result = await pool.query(
      `INSERT INTO addon_preset_items (addon_preset_id, menu_item_id, addon_discount_price_cents, is_available)
       VALUES ($1, $2, $3, true)
       RETURNING *`,
      [presetId, menu_item_id, addon_discount_price_cents]
    );
...
router.delete('/restaurants/:restaurantId/addon-presets/:presetId/items/:itemId', async (req: Request, res: Response) => {
  try {
    ...
    await pool.query(
      `DELETE FROM addon_preset_items WHERE id = $1 AND addon_preset_id = $2`,
      [itemId, presetId]
    );
...
router.delete('/restaurants/:restaurantId/addon-presets/:presetId', async (req: Request, res: Response) => {
  try {
    ...
    const result = await pool.query(
      `DELETE FROM addon_presets WHERE id = $1 AND restaurant_id = $2 RETURNING id`,
      [presetId, restaurantId]
    );
...
router.get('/restaurants/:restaurantId/variant-presets/:presetId', async (req: Request, res: Response) => {
  try {
    ...
    const result = await pool.query(
      `SELECT * FROM variant_presets WHERE id = $1 AND restaurant_id = $2`,
      [presetId, restaurantId]
    );
...
router.get('/restaurants/:restaurantId/variant-presets/:presetId/variants', async (req: Request, res: Response) => {
  try {
    ...
    const result = await pool.query(
      `SELECT vpi.id, vpi.variant_preset_id, vpi.variant_id,
...
router.post('/restaurants/:restaurantId/variant-presets', async (req: Request, res: Response) => {
  try {
    ...
    const result = await pool.query(
      `INSERT INTO variant_presets (restaurant_id, name, description, is_active)
       VALUES ($1, $2, $3, $4)
       RETURNING *`,
      [restaurantId, name, description || null, is_active]
    );
...
router.post('/restaurants/:restaurantId/variant-presets/:presetId/variants', async (req: Request, res: Response) => {
  try {
    ...
    const result = await pool.query(
      `INSERT INTO variant_preset_items (variant_preset_id, variant_id)
       VALUES ($1, $2)
       RETURNING *`,
      [presetId, variant_id]
    );
...
router.delete('/restaurants/:restaurantId/variant-presets/:presetId/variants/:variantId', async (req: Request, res: Response) => {
  try {
    ...
    await pool.query(
      `DELETE FROM variant_preset_items WHERE variant_preset_id = $1 AND variant_id = $2`,
      [presetId, variantId]
    );
...
router.delete('/restaurants/:restaurantId/variant-presets/:presetId', async (req: Request, res: Response) => {
  try {
    ...
    const result = await pool.query(
      `DELETE FROM variant_presets WHERE id = $1 AND restaurant_id = $2 RETURNING id`,
      [presetId, restaurantId]
    );
